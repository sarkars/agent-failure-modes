...
Agents that verify outputs and evaluate other agent behavior

## Goals

| Goal | Description | Patterns |
|------|-------------|----------|
| [Verification](goals/verification/) | Verify correctness and safety of outputs | 15 |

**Total: 15 patterns across 1 goals**
